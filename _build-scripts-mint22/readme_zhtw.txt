...
step1 安裝環境： setup_fcitx5_env_v1.2.sh，這個腳本負責移除舊版 Fcitx4 (如果有的話)、安裝 Fcitx5 核心組件，並設定必要的環境變數。
step2 編譯： install_mcbopomofo_v1.2.sh 編譯指令，並加入了相依套件的自動檢查
step3 使用： 左下角選單：開始/管理/Fcitx5啟動中文輸入法。或加入開機的 rc 檔。
